                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body taxo-category">
                        <div v-for="category in categories" v-bind:key="category.id" class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="portfolio.category[]" :id="category.id" :value="category" v-model="portfolio.category">
                            <label class="custom-control-label" :for="category.id">{{ category.name }}</label>
                        </div>
                    </div>
                    <span class="p-4">
                    Test categories: {{ portfolio.category }}</span>
