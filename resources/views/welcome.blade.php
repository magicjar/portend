...
<head>
    ...
    <body data-spy="scroll" data-target="#scroll-sidebar" data-offset="0">
        <section class="container-flexible">
            <nav id="scroll-sidebar" class="sidebar navbar navbar-light fixed-top float-left">
                <div class="avatar text-center">
                    <img class="rounded-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
                </div>
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link" href="#carouselExampleControls">Welcome</a>
